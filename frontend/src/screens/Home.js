        ...
        <Col sm={12} md={6} className="mb-5">
          <div className="centerd my-5">
            ...
            <p>
              ...
              location in a relatively economically depressed area of Utica. The
              potential not only in this location but the whole area was seen by
              our founder & president, Frank Elias.
            </p>
            <div>
              <Link to="/menu" className="btn btn-success  w-50 text-white ">
                Order now
              </Link>
            </div>
          </div>
